...
public class QingCloudWSClient implements IQingCloudWSClient {
    ...
    public DescribeAlarmsResponse describeAlarms(DescribeAlarmsRequest describeAlarmsRequest)
            throws QingCloudClientException, QingCloudServiceException, IOException {
        DescribeAlarmsResponse describeAlarmsResponse = null;
        String httpMethod = "GET";
    ...
    public DescribeAlarmPoliciesResponse describeAlarmPolicies(DescribeAlarmPoliciesRequest describeAlarmPoliciesRequest)
            throws QingCloudClientException, QingCloudServiceException, IOException {
        DescribeAlarmPoliciesResponse describeAlarmPoliciesResponse = null;
        String httpMethod = "GET";
        String action = QingCloudAction.DESCRIBE_ALARM_POLICIES;
    ...
    public DescribeAlarmPolicyRulesResponse describeAlarmPolicyRules(DescribeAlarmPolicyRulesRequest describeAlarmPolicyRulesRequest)
            throws QingCloudClientException, QingCloudServiceException, IOException {
        DescribeAlarmPolicyRulesResponse describeAlarmPolicyRulesResponse = null;
        String httpMethod = "GET";
        String action = QingCloudAction.DESCRIBE_ALARMS_POLICY_RULES;

        try {
            String jsonResponse = this.sendRequest(httpMethod, action,
                    describeAlarmPolicyRulesRequest);
            describeAlarmPolicyRulesResponse = DescribeAlarmPolicyRulesResponse
                    .fromJson(jsonResponse);
        } catch (QingCloudClientException e) {
            throw e;
        } catch (QingCloudServiceException e) {
        ...
        return describeAlarmPolicyRulesResponse;
    }
